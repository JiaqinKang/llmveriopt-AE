...
TV_SMT_STATS=""
if [[ 0 == 0 ]]; then
  TV_REPORT_DIR=-tv-report-dir=/home/alone/Desktop/alive2-work/alive2/build/logs
...
if [[ $SKIP_TV == 0 && $NPM_TV == 1 ]]; then
  NPM_PLUGIN="-load-pass-plugin=/home/alone/Desktop/alive2-work/alive2/build/tv/$TV_SHAREDLIB"
fi

COMMAND="$TIMEOUT /home/alone/Desktop/alive2-work/llvm-project/build/bin/opt -load=/home/alone/Desktop/alive2-work/alive2/build/tv/$TV_SHAREDLIB  $NPM_PLUGIN -tv-exit-on-error $TV $OPT_ARGS $TV $TV_SMT_TO $TV_REPORT_DIR $TV_SMT_STATS"
